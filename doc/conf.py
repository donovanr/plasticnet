...
# -*- coding: utf-8 -*-
#
# plastic_net documentation build configuration file, created by
...
htmlhelp_basename = "plastic_netdoc"
...
man_pages = [
    ("index", "plastic_net", "plastic_net Documentation", ["Rory Donovan-Maiye"], 1)
]
